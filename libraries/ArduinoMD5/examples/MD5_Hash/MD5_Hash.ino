...
void setup()
{
  ...
  //Give the Memory back to the System if you run the md5 Hash generation in a loop
      if (strcmp (md5str,"5eb63bbbe01eeed093cb22bb8f5acdc3") == 0){
      //if(md5str == "5eb63bbbe01eeed093cb22bb8f5acdc3"){
          Serial.println("Verify MD5 : True");
      }else{
          Serial.println("Verify MD5 : False");
      }
  free(md5str);
}
